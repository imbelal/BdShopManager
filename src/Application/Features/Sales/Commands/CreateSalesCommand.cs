...
namespace Application.Features.Sales.Commands
{
    public class CreateSalesCommand : ICommand<Guid>
    {
        ...
        public CreateSalesCommand(Guid customerId, decimal totalPrice, decimal totalPaid, string remark, List<SalesItemDetailsDto> salesItemDtos, decimal taxPercentage = 0)
        {
